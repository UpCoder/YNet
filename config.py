...
min_object_covered = 0.5          # Minimum object to be cropped in random crop.
...
feat_layers = ['conv2_2', 'conv3_3', 'conv4_3', 'fc7']
strides = [1]
# model_type = pixel_link_symbol.MODEL_TYPE_vgg16
...
pixel_cls_loss_weight_lambda = 3.0
